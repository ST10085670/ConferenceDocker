    ...
    public partial class InitalMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attenddee", x => x.AttendeeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Registrations_Attenddee_AttendeeID",
                        column: x => x.AttendeeID,
                        principalTable: "Attenddee",
            ...
            migrationBuilder.InsertData(
                table: "Registrations",
                columns: new[] { "RegistrationID", "AttendeeID", "RegDate", "SessionID" },
                values: new object[,]
                {
