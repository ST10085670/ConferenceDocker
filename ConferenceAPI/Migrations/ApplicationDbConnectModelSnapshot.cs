...
namespace ConferenceAPI.Migrations
{
    ...
    partial class ApplicationDbConnectModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("ConferenceAPI.Models.Registration", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RegistrationID = 1,
                            AttendeeID = 1,
                            RegDate = new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SessionID = 101
                        },
                        new
                        {
                            RegistrationID = 2,
                            AttendeeID = 2,
                            RegDate = new DateTime(2025, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SessionID = 102
                        },
                        new
                        {
                            RegistrationID = 3,
                            AttendeeID = 3,
                            RegDate = new DateTime(2025, 3, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SessionID = 103
                        });
                });
