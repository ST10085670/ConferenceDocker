...
CREATE TABLE Registrations (
	...
	RegistrationsID INT PRIMARY KEY IDENTITY (1,1),
...
('Jane', 'Smith', 'jane.doe@example.com'),
('Emily', 'Jones', 'emily.doe@example.com');
GO

-- Insert data into Sessions table
INSERT INTO Sessions (SessionTitle, SessionDateTime, Speaker)
VALUES
('Introduction to C#', '2025-04--1 09:00:00', 'Dr. Alan Turing'),
